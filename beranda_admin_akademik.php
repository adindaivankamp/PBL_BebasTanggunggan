...
<body>
            ...
            <div class="notification-item">
                ...
                <div class="notification-actions">
                    <button class="view-btn"
                        data-pdf="Assets/contoh_skripsi.pdf">View</button>
            ...
            <div class="modal-content">
                ...
                <div class="student-modal-buttons">
                    <div class="student-modal-item">
                        <p>Surat Pelunasan UKT Semester 1 - Lulus</p>
                        <button class="btn-tolak">View</button>
                    </div>
                    <div class="student-modal-item">
                        <p>Foto Diri untuk Ijazah</p>
                        <button class="btn-tolak">View</button>
                    </div>
                    <div class="student-modal-item">
                        <p>Surat Lulus SKKM</p>
                        <button class="btn-tolak">View</button>
                    </div>
                    <div class="student-modal-item">
                        <p>Pengisian Data Alumni</p>
                        <button class="btn-tolak">View</button>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        // Due to the dynamic nature of the content, we need to use event delegation
        // document.querySelectorAll('..btn-ijo').forEach(button => {
        //     button.addEventListener('click', () => {
        ...
        document.getElementById("studentList").addEventListener('click', (e) => {
            if (e.target.classList.contains('btn-ijo')) {
                ...
                if (targetModal) {
                    ...
                    fetch(`BackEnd/ProcessData.php?type=file&func=GetFileByJenisDokumenAndNim&nim=${data.nama}&jenis_dokumen=Bebas Tanggungan Akademik&token=${document.cookie.split("token=")[1].split(";")[0]}`)
                        ...
                        .then(response => {
                            ...
                            for (let i = 0; i < JSONData.length; i++) {
                                if (JSONData[i].kategori == "Surat Pelunasan UKT Semester 1 - Lulus") {
                                ...
                                } else if (JSONData[i].kategori == "Foto Diri untuk Ijazah") {
                                    if (JSONData[i].status_validasi == 0)
                                ...
                                } else if (JSONData[i].kategori == "Surat Lulus SKKM") {
                                    if (JSONData[i].status_validasi == 0)
                                ...
                                } else if (JSONData[i].kategori == "Pengisian Data Alumni") {
                                    if (JSONData[i].status_validasi == 0)
