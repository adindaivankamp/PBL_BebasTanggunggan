            ...
            <div class="modal-content">
                ...
                <div class="student-modal-buttons">
                    <div class="student-modal-item">
                        <p>Laporan Tugas Akhir/Skripsi</p>
                        <button class="btn-tolak">View</button>
                    </div>
                    <div class="student-modal-item">
                        <p>Program/Aplikasi Tugas Akhir/Skripsi</p>
                        <button class="btn-tolak">View</button>
                    </div>
                    <div class="student-modal-item">
                        <p>Surat Pernyataan Publikasi Skripsi</p>
                        <button class="btn-tolak">View</button>
                    </div>
                    <div class="student-modal-item">
                        <p>Jurnal/Paper/Conference/Seminar/HAKI</p>
                        <button class="btn-tolak">View</button>
                    </div>
                </div>
            </div>
                    ...
                    fetch(`BackEnd/ProcessData.php?type=file&func=GetFileByJenisDokumenAndNim&nim=${data.nama}&jenis_dokumen=Bebas Tanggungan Skripsi%2FTA&token=${document.cookie.split("token=")[1].split(";")[0]}`)
                        ...
                        .then(response => {
                            ...
                            for (let i = 0; i < JSONData.length; i++) {
                                if (JSONData[i].kategori == "Laporan Tugas Akhir/Skripsi") {
                                ...
                                } else if (JSONData[i].kategori == "Program/Aplikasi Tugas Akhir/Skripsi") {
                                    if (JSONData[i].status_validasi == 0)
                                ...
                                } else if (JSONData[i].kategori == "Surat Pernyataan Publikasi Skripsi") {
                                    if (JSONData[i].status_validasi == 0)
                                ...
                                } else if (JSONData[i].kategori == "Jurnal/Paper/Conference/Seminar/HAKI") {
                                    if (JSONData[i].status_validasi == 0)
