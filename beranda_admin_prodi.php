            ...
            <div class="modal-content">
                ...
                <div class="student-modal-buttons">
                    <div class="student-modal-item">
                        <p>Tanda Terima Penyerahan Laporan Tugas Akhir/Skripsi</p>
                        <button class="btn-tolak">View</button>
                    </div>
                    <div class="student-modal-item">
                        <p>Tanda Terima Penyerahan Laporan PKL/Magang</p>
                        <button class="btn-tolak">View</button>
                    </div>
                    <div class="student-modal-item">
                        <p>Surat Bebas Kompen</p>
                        <button class="btn-tolak">View</button>
                    </div>
                    <div class="student-modal-item">
                        <p>Scan TOEIC</p>
        ...
        document.getElementById("studentList").addEventListener('click', (e) => {
            if (e.target.classList.contains('btn-ijo')) {
                ...
                if (targetModal) {
                    ...
                    fetch(`BackEnd/ProcessData.php?type=file&func=GetFileByJenisDokumenAndNim&nim=${data.nama}&jenis_dokumen=Bebas Tanggungan Program Studi&token=${document.cookie.split("token=")[1].split(";")[0]}`)
                        ...
                        .then(response => {
                            ...
                            for (let i = 0; i < JSONData.length; i++) {
                                if (JSONData[i].kategori == "Tanda Terima Penyerahan Laporan Tugas Akhir/Skripsi") {
                                ...
                                } else if (JSONData[i].kategori == "Tanda Terima Penyerahan Laporan PKL/Magang") {
                                    if (JSONData[i].status_validasi == 0)
                                ...
                                } else if (JSONData[i].kategori == "Surat Bebas Kompen") {
                                    if (JSONData[i].status_validasi == 0)
                                ...
                                } else if (JSONData[i].kategori == "Scan TOEIC") {
                                    if (JSONData[i].status_validasi == 0)
